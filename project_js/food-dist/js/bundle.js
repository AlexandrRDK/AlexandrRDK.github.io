...
function culc() {
    ...
    function culcTotal() { // расчитывает результат
    ...
    function getStaticInformation (selector, activeClass) { // при клике записывает информацию в переменные
        const elements = document.querySelectorAll(selector);
    ...
    function getDinamicInformation (selector) { // получение значений из инпутов
...
function sendForm(formSelector, modalTimerId) {
...
function timer(id, deadline) {
    ...
    function getZero(num) { // подставляет нули если число не двузначное например: из 9 сделает
        if (num  >= 0 && num < 10) {
            return `0${num}`;
        } else {
            return num;
...
/*!**********************!*\
  ...
  \**********************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _modules_culc__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/culc */ "./js/modules/culc.js");
/* harmony import */ var _modules_cards__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/cards */ "./js/modules/cards.js");
/* harmony import */ var _modules_modal__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/modal */ "./js/modules/modal.js");
/* harmony import */ var _modules_sendForm__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/sendForm */ "./js/modules/sendForm.js");
...
window.addEventListener('DOMContentLoaded', () => {//скрипт будет работать после полной загрузки страницы
    ...
    const modalTimerId = setTimeout(() => (0,_modules_modal__WEBPACK_IMPORTED_MODULE_2__.openModal)('.modal', modalTimerId), 50000); // через n секунд открывает модальное окно

    (0,_modules_tabs__WEBPACK_IMPORTED_MODULE_5__["default"])('.tabheader__item', '.tabcontent', '.tabheader__items', 'tabheader__item_active');
    (0,_modules_culc__WEBPACK_IMPORTED_MODULE_0__["default"])();
    (0,_modules_cards__WEBPACK_IMPORTED_MODULE_1__["default"])();
    (0,_modules_modal__WEBPACK_IMPORTED_MODULE_2__["default"])('[data-modal]', '.modal', modalTimerId);
    (0,_modules_sendForm__WEBPACK_IMPORTED_MODULE_3__["default"])('form', modalTimerId);
    ...
    (0,_modules_timer__WEBPACK_IMPORTED_MODULE_6__["default"])('.timer', '2024-08-27');
});
